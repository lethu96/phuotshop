    ...
    <div class="">
            ...
            <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                              <div class="x_title">
                                <p class="text-muted"><button type="button" class="btn btn-info btn-md" id="add"  ><a href="{{asset('/typeproduct/create')}}" > <i class="fa fa-plus-circle" aria-hidden="true"></i>Thêm mới</a>
                            </button>
                            </p>
                                  ...
                                  <tbody>
                                    @foreach($data as $item)
                                        <tr>
                                            ...
                                            <td>{{$item['status']}}</td>
                                            <td>
                                                <a href="{{asset('/typeproduct/update/').'/'.$item['id']}}" class="btn btn-primary ">
